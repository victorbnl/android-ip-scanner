...
class ResultsAdapter(private val dataSet: MutableList<Device>) : RecyclerView.Adapter<ResultsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_results, parent, false))
